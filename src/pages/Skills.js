      ...
      <div className="skills">
        <div className="skill">
          ...
          <div className="skillbar">
            <div className="skillperc" per="90%" style={{maxWidth: "90%"}}></div>
          </div>
        </div>
        <div className="skill">
          <div className="skillname">SQL</div>
          <div className="skillbar">
            <div className="skillperc" per="80%" style={{maxWidth: "80%"}}></div>
          </div>
        </div>
        <div className="skill">
          <div className="skillname">Frontend</div>
          <div className="skillbar">
            <div className="skillperc" per="50%" style={{maxWidth: "50%"}}></div>
          </div>
        </div>
      </div>

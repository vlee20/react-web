...
export default function About() {
  return (
    <>
      <h1 className="center text-center">About</h1>
      <div className="abt">
        ...
        <div>
          ...
          <p>
            ...
            Overstock. While I had no prior experience with networking, I
            quickly familiarized myself with DNS configuration and SSL
            implementation to deliver a fully functional API.
          </p>
          <p>
